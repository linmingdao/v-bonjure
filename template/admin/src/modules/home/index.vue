            ...
            >
                <template v-for="mItemL1 in menus">
                    ...
                    <el-menu-item v-if="!mItemL1.children && mItemL1.icon" :key="mItemL1.tabId" :index="mItemL1.tabId">
                        ...
                        <span slot="title">{{mItemL1.title}}</span>
                    </el-menu-item>
                    <!-- 一级菜单，有子菜单 -->
                    <el-submenu
                    ...
                    >
                        ...
                        <template v-for="mItemL2 in mItemL1.children">
                            ...
                            >
                                ...
                                <span slot="title">{{mItemL2.title}}</span>
                            </el-menu-item>
                            <!-- 二级菜单，有子菜单，带icon -->
                            <el-submenu
                            ...
                            >
                                ...
                                <template v-for="mItemL3 in mItemL2.children">
                                    ...
                                    <el-menu-item :key="mItemL3.tabId" :index="mItemL3.tabId">
                                        ...
                                        <span slot="title">{{mItemL3.title}}</span>
                                    </el-menu-item>
                                </template>
                            </el-submenu>
                        </template>
        ...
        <el-container>
            ...
            <el-main class="main-body">
                ...
                <el-tabs
                    ...
                    @tab-click="clickTab"
                >
                    <el-tab-pane v-for="item in dynamicTabs" :key="item.tabId" :label="item.title" :name="item.tabId">
